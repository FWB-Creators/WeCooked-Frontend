...
import GroupCardUnenrolled from '../group/search/GroupCardUnenrolled'

export default function CompleteGroupCourse() {
  ...
  return (
    <div className="relative flex flex-col justify-start py-12">
      <h1 className="text-3xl font-bold mb-2 bg-gradient-to-b from-[#F0725C] to-[#FE3511] inline-block text-transparent bg-clip-text px-12">
        {title
          ? `Found ${filteredGroups.length} workshops for "${title}"`
          : 'Workshops'}
      </h1>
      <div className="mx-12">
