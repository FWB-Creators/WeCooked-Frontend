    ...
    <div className="flex justify-center items-center bg-gradient-to-t from bg-[#FE3511]/75 to bg-[#F0725C]/75 w-full h-screen animate-fadeIn">
      ...
      <div className="rounded-2xl z-10 bg-white w-[680px] h-[440px] p-2">
        ...
        <form
          ...
          className="font-semibold cursor-pointer py-3 px-4 items-center rounded-[5px] flex justify-center ml-10 mr-12 mt-6 font-semi-bold text-[white] bg-gradient-to-t from-[#FE3511] to-[#F0725C] transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg"
        >
      ...
      <div className="absolute left-64 bottom-0 opacity-75" aria-hidden="true">
        <Image src="/images/burger.png" alt="burger" width={350} height={350} />
      </div>
      <div
        className="absolute left-[-150px] bottom-28 opacity-75"
        aria-hidden="true"
      >
        <Image src="/images/steak.png" alt="steak" width={400} height={400} />
      </div>
      <div className="absolute left-0 top-5 opacity-75" aria-hidden="true">
        <Image src="/images/pasta.png" alt="pasta" width={500} height={500} />
      </div>
      <div className="absolute left-64 top-5 opacity-75" aria-hidden="true">
        <Image src="/images/waffle.png" alt="waffle" width={250} height={250} />
      </div>
      <div className="absolute right-5 bottom-5 opacity-75" aria-hidden="true">
        <Image src="/images/sushi.png" alt="sushi" width={400} height={400} />
      </div>
      <div className="absolute left-0 bottom-5" aria-hidden="true">
        <Image
      ...
      <div className="absolute right-64 top-5" aria-hidden="true">
        <Image
      ...
      <div className="absolute right-0 top-5" aria-hidden="true">
        <Image
      ...
      <div className="absolute right-[-50px] bottom-28" aria-hidden="true">
        <Image
      ...
      <div className="absolute right-64 bottom-5" aria-hidden="true">
        <Image
